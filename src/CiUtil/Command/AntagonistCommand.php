...
class AntagonistCommand {
  static function main($argv) {
    ...
    $candidateTests = \CiUtil\PHPUnitScanner::findTestsByPath(array($suite));
...
//    );
  ...
  static function findAntagonist($target, $candidateTests) {
    //$phpUnit = new \CiUtil\EnvTestRunner('./scripts/phpunit', 'EnvTests');
    $phpUnit = new \CiUtil\EnvTestRunner('phpunit', 'tests/phpunit/EnvTests.php');
